...
O dashboard também desempenha papel relevante neste pilar, oferecendo supervisão, registro de incidentes, visualização de rotas e geração de relatórios. Esses elementos contribuem para rastreabilidade e conformidade com RDC nº 430/2020 e normas GDP de cadeia fria (GDP, 2023).
...
RAO, A. et al. IoT Power Systems for Critical Monitoring. IEEE, 2021.
...
BANKS, A. et al. MQTT – The Standard for IoT Messaging. OASIS, 2022.

Disponível em: https://mqtt.org

Acesso em: 17 nov. 2025.



GARCÍA-MURILLO, M. et al. Secure MQTT Architectures with X.509 Authentication. Sensors, 2021.
...
ANVISA. Boas Práticas de Distribuição e Armazenamento. RDC nº 430, 2020.
...
WORLD HEALTH ORGANIZATION (WHO). Guidelines on the International Packaging and Shipping of Vaccines. Geneva: WHO, 2023.
...
SILVA, T. et al. MySQL in Industrial IoT Architectures. Journal of Systems Engineering, 2022.

Disponível em: https://journalofsystemsengineering.org

Acesso em: 17 nov. 2025.



INTERNATIONAL ORGANIZATION FOR STANDARDIZATION (ISO). ISO/IEC 27001 – Information Security Management Systems. Geneva: ISO, 2022.

Disponível em: https://www.iso.org

Acesso em: 17 nov. 2025.



NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY (NIST). Contingency Planning Guide for Federal Information Systems. SP 800-34, 2023.
...
NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY (NIST). Network-of-Things Framework. SP 800-183, 2020.
...
GOOD DISTRIBUTION PRACTICES (GDP). Good Distribution Practices for Temperature-Sensitive Products. 2023.

Disponível em: https://www.gooddistributionpractices.com
